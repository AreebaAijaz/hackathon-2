    ...
    <main>
      <div className=" bg-light-grey ">
        <div className="container py-10 flex justify-between items-center">
          ...
          {/* details */}
          <div className="space-y-3 container mr-24">
            <div>
              <p className="text-custom-h1 font-display">The Dandy Chair </p>
              <p className="text-custom-h3">£250</p>
            </div>
            <hr />
            ...
            <div className="flex gap-x-6 pt-7 text-body-md">
